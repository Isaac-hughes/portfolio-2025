    ...
    <section className="min-h-[90vh] flex items-center justify-center z-10 bg-background/95 px-4">
      <Container className="py-8 md:py-20">
        <div className="w-full max-w-4xl mx-auto">
          <div className="relative rounded-lg bg-black/20 backdrop-blur-sm p-4 md:p-8 shadow-lg">
            <div
              className="absolute inset-0 rounded-lg animate-border-gradient"
              style={{
                backgroundImage:
                  "linear-gradient(90deg, var(--accent-primary) 0%, var(--accent-secondary) 50%, var(--accent-primary) 100%)",
